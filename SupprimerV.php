...
<div class="container">
  <div class="row mt-5">
    <div class="col-lg-12">
    <h2>Mon Espace Vendeur --> Supprimer un article de la vente</h2>
    </div>
  </div>
</div>
...
$id=$donne['IdV'];
  ...
  $sql = "SELECT * FROM `articles` Where Pending = 1 AND IdV = '$id'";
...
while ( $donnees = mysqli_fetch_assoc($req))  // Renvoit les valeurs de la bdd
        ...
        type="button" value="'.$donnees['IdArt'].'" name="IdVrefuse">
