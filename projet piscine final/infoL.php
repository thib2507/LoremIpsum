...
<form action="infoL1.php" method="post">
		...
		<div class="row justify-content-lg-center">
			<div class="col-lg-4 mt-4">
				<h6>Informations livraison</h6>
						...
						<input type="text" class="form-control" placeholder="Adresse 1" name="Adresse1" required> <br>
						<input type="text" class="form-control" placeholder="Adresse 2" name="Adresse2" required> <br>
						<input type="text" class="form-control" placeholder="Ville" name="Ville" required> <br>
						<input type="text" class="form-control" placeholder="Code postal" name="CodePostal" required> <br>
						<input type="text" class="form-control" placeholder="Pays" name="Pays" required> <br>
						<input type="text" class="form-control" placeholder="Téléphone" name="Telephone" required> <br>
	...
	<input type="submit" class="btn btn-secondary btn-block" value="continuer vers le paiement" name="next">
		</div>
	</div>
 </form>
