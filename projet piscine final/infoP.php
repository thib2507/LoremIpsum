...
<form action="infoP1.php" method="post">
	<div class="container-fluid">
		<div class="row justify-content-lg-center">
			<div class="col-lg-4 mt-4">
				<h6>Informations banquaires</h6>

                        <select class="form-control" id="moyen" name="type" placeholder="Moyen de paiement">
                        ...
                        <br>
                        <p>Propriétaire de la carte</p>
                        <input type="text" class="form-control" placeholder="Propriétaire de la carte" name="proprio" required> <br>
                        <p>Numéro de la carte</p>
                        <input type="number" class="form-control" placeholder="XXXX XXXX XXXX XXXX" name="card" required> <br>
                        <p>Date d'expiration</p>
                        <input type="date" class="form-control" placeholder="mm/aa" name="exp" required> <br>
                        <p>cryptogramme</p>
						<input type="number" class="form-control" placeholder="XXX" name="crypt" required> <br>
	...
	<input type="submit" class="btn btn-secondary btn-block" value="Valider le paiement" name="next">
		</div>
	</div>
 </form>
