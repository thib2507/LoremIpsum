...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="Home.php"><img src="logoseller.png" width="200" height="70"/></a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="AjoutV.php">Ajouter un article à la vente</a>
          ...
          <div class="container-fluid px-0">
            <div class="row mx-0">
              <div class="col-12 px-0">
                 <a href="#"><img src="<?php echo $img;?>" width="100%" height="300" /></a>
              <form action="PhotoVendeur.php" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-4 mt-5">
                  <input type="submit" class="btn btn-secondary btn-block" value="valider la photo" name="ajouter">
                </div>
                </div>
                </div>
              </form>
          ...
          <div class="card mt-5">
            ...
            <div class="card-body">
              <h5 class="card-title">Articles vendus</h5>
               <p class="card-text">Accédez à votre historique de ventes et au montant de votre solde sur notre site.</p>
                 <a href="ArticlesVendus.php" class="btn btn-primary">Accéder</a>
         </div>
        </div>
      </div>
           ...
           <div class="card-body">
             <h5 class="card-title">Ajouter un article</h5>
               <p class="card-text">Ajoutez un article à la vente en renseignant toutes les informations nécessaires.</p>
                 <a href="AjoutV.php" class="btn btn-primary">Ajouter</a>
         </div>
        </div>
      </div>
      <div class="col-lg-4">
          <div class="card mt-5">
           ...
           <div class="card-body">
             <h5 class="card-title">Supprimer un article</h5>
               <p class="card-text">Supprimez un article que vous avez mis en vente.</p>
                 <a href="SupprimerV.php" class="btn btn-primary">Supprimer</a>
         </div>
        </div>
      </div>
