...
<link rel="stylesheet" type="text/css" href="HPV.css">
...
<form action="HPV1.php" method="post">
<div class="container">
	<div class="row justify-content-lg-center">
	<div class="col-lg-4 mt-4">
	
		<h3 class="feature-title">Connectez vous!</h3>
			...
			<div class="form-group">
				...
				<a href="HPVconnect.php">Inscrivez-vous si vous n'avez pas de compte</a>
