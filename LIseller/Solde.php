...
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <h2>Mon Espace Vendeur --> Mon solde</h2>
    </div>

      <div class="row mt-5">
        
          <div class="card simplebar" >
          
            <div class="card-body">
              <div class="panel panel-primary">
                  <div class="panel-heading">
                    <h3 class="panel-title">Mon solde vendeur</h3>
              ...
              <div class="panel-body">
                  <div class="tab-content">
                    ...
                    CONTENT
                    kjzebdf<br>azufbaezofv<br>bazeofuvaezofav<br>ve<br>bzf<br>ocua<br>ezv<br>bfo<br>aze<br>vbcb<br>foaebvc<br>oae<br>zjbcf<br>aezp<br>fbaz<br>efbazefbaefbaefbaecfoae
                    </div>
                  </div>
              </div>
              </div>
