...
<div class="container-fluid px-0">
            <div class="row mx-0">
              <div class="col-12 px-0">
                 <a href="#"><img src="photodecouv.png" width="100%"" height="300" /></a>
            ...
            <div class="card-body">
              <h5 class="card-title">Articles vendus</h5>
               <p class="card-text">Accédez à votre historique de ventes et au montant de votre solde sur notre site.</p>
                 <a href="AV.html" class="btn btn-primary">Accéder</a>
         </div>
        </div>
      </div>
     <div class="col-lg-4">
          <div class="card mt-5">
            ...
            <div class="card-body">
              <h5 class="card-title">Mon solde vendeur</h5>
               <p class="card-text">Accédez à votre historique de ventes et au montant de votre solde sur notre site.</p>
                 <a href="Solde.html" class="btn btn-primary">Voir mon solde</a>
         </div>
        </div>
      </div>
     <div class="col-lg-4">
           ...
           <div class="card-body">
             <h5 class="card-title">Ajouter un article</h5>
               <p class="card-text">Ajoutez un article à la vente en renseignant toutes les informations nécessaires.</p>
                 <a href="AjoutV.html" class="btn btn-primary">Ajouter</a>
         </div>
        </div>
      </div>
    </div>
...
<!--<div class="container mt-5">
      ...
      <div class="col-md-6">
        <div class="panel panel-success">
          <div class="panel-heading">
            <center><h3 class="panel-title">Dernières commandes</h3></center>
