...
<form action="AjoutFinV.php" method="post" enctype="multipart/form-data">
		...
		<div class="row justify-content-lg-center">
			<div class="col-lg-4 mt-4">
				<h6>Catégorie vêtements</h6>
								...
								<div class="form-group row mt-5" enctype="multipart/form-data" >
				...
				<div class="row">
					<div class="col-lg-4 mt-4">
						<div class="form-group" name="Taille1">
									<label for="Taille1">Taille :</label>
										<select class="form-control" name="Taille1" id="Taille" placeholder="Taille">
											<option>S</option>
											<option>M</option>
											<option>L</option>
											<option>XL</option>
						...
						<div class="form-group" name="Sexe1" required>
								<label for="Sexe1">Sex :</label>
									<input type="radio" name="Sexe1" value="H" checked> Homme 
					...
					<div class="col-lg-4 mt-4">
						<div class="form-group">
									<label for="Taille2">Taille :</label>
										<select class="form-control" name="Taille2"id="Taille" placeholder="Taille">
											<option>S</option>
											<option>M</option>
											<option>L</option>
											<option>XL</option>
						...
						<div class="form-group" name="Sexe2">
								<label for="Sexe2">Sex :</label>
									<input type="radio" name="Sexe2" value="H" checked> Homme 
						...
						<div class="form-group">
									<label for="Couleur2">Couleur :</label>
										<select class="form-control" name="Couleur2" id="Couleur" placeholder="Couleur">
											<option>Bleu</option>
											<option>Rouge</option>
											<option>Vert</option>
											<option>Jaune</option>
					...
					<div class="col-lg-4 mt-4">
						<div class="form-group" name="Taille3">
						...
						<div class="form-group">
								<label for="Sexe3">Sex :</label>
									<input type="radio" name="Sexe3" value="H" checked> Homme 
									<input type="radio" name="Sexe3" value="F"> Femme 
...
<form action="AjoutFinL.php" method="post" enctype="multipart/form-data">
	<div class="container-fluid">
	 <div class="row justify-content-lg-center">
		<div class="col-lg-4 mt-4">
...
<form action="AjoutFinM.php" method="post" enctype="multipart/form-data">
	<div class="container-fluid">
	 <div class="row justify-content-lg-center">
		<div class="col-lg-4 mt-4">
...
<form action="AjoutFinS.php" method="post" enctype="multipart/form-data">
	<div class="container-fluid">
	 <div class="row justify-content-lg-center">
		<div class="col-lg-4 mt-4">
