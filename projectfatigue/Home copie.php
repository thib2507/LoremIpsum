...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="Base.html"><img src="logow.png" width="200" height="70"/></a>
        ...
        <div class="container-fluid px-0">
            <div class="row mx-0">
              <div class="col-12 px-0">
                 <a href="#"><img src="header-flash-sales.gif" width="100%" /></a>
        ...
        if ($db_found) {
            $sql = "SELECT * FROM articles WHERE Type = 2 ORDER BY CmptVendu DESC LIMIT 6";
        }
        ...
        <h3>Meilleurs ventes vetements</h3>
  ...
  <section class="center slider">
    ...
    <div class="box">
      ...
      <p class="HiddenText">Aperçu</p>
        ...
        <h3>Meilleurs ventes Musique</h3>
