...
$sql1 = "INSERT INTO articles (Nom, Descr, Prix, Type, Pending, IdV, CmptVendu) VALUES ('$NomA','$Description','$PrixV', '5', '0','$iv', '0')";
...
$sql2 = "INSERT INTO sports (IdArt, Quantite) VALUES ('$ia','$Quantite')";

if ($conn->query($sql2) == true) 
{ 
    echo "inserted sport successfully."; 
} 
else
{ 
